...
ActiveRecord::Schema.define(version: 2022_02_02_054225) do
  ...
  create_table "sending_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buyer_id"], name: "index_sending_addresses_on_buyer_id"
  end
  ...
  add_foreign_key "sending_addresses", "buyers"
end
